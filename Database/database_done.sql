...
CREATE TABLE `tbl_friends` (
  ...
  `created` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `tbl_friends` VALUES (1,4,1,1,'1619342312'),(2,4,2,0,NULL),(1,3,3,0,NULL),(2,3,4,0,NULL),(1,2,5,0,NULL),(5,4,6,1,'1619342002'),(3,4,7,1,'1619344004'),(4,6,8,1,'1619341001');
...
CREATE TABLE `tbl_report` (
  `id` int NOT NULL AUTO_INCREMENT,
  `subject` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `details` varchar(1000) COLLATE utf8mb4_bin DEFAULT NULL,
  `id_post` int DEFAULT NULL,
  `id_user` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_post_report_idx` (`id_post`),
  KEY `fk_user_report_idx` (`id_user`),
  CONSTRAINT `fk_post_report` FOREIGN KEY (`id_post`) REFERENCES `tbl_posts` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_user_report` FOREIGN KEY (`id_user`) REFERENCES `tbl_users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `tbl_report` VALUES (1,'Bài viết sai chuẩn mực','Bài viết có ngôn ngữ gây chia rẽ',1,1),(2,'Bài viết sai chuẩn mực','Bài viết có ngôn ngữ gây chia rẽ',9,1);
...
INSERT INTO `tbl_users` VALUES (1,'092872121','12334','bui','avatar.img'),(2,'092231321','1233223','nguyen','avatar.img'),(3,'0923872132','1233432322','vu','avatar.img'),(4,'0904515270','123456','vo',NULL),(5,'0912345678','123456','tran',NULL),(6,'0923458799','123456','trinh',NULL);
...
-- Dump completed on 2021-06-11 10:43:34
